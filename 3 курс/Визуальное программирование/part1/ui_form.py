...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_0_0 = QPushButton(self.gridContainer)
        self.btn_0_0.setObjectName(u"btn_0_0")

        self.gridLayout.addWidget(self.btn_0_0, 0, 0, 1, 1)

        self.btn_0_1 = QPushButton(self.gridContainer)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_0_0.setText(QCoreApplication.translate("MainWindow", u"PushButton", None))
        self.btn_0_1.setText(QCoreApplication.translate("MainWindow", u"PushButton", None))
